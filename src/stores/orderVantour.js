...
export const useOrderVantourStore = defineStore("orderVantour", {
    ...
    actions: {
        changeStoreData(data) {
            ...
            if (data.attraction_date) {
                this.attraction_date = data.attraction_date;
                localStorage.setItem(
                    "attraction_date",
                    JSON.stringify(data.attraction_date)
                );
            }
        ...
        getAttractionData() {
            let attraction_date = JSON.parse(localStorage.getItem("attraction_date"));
            this.attraction_date = attraction_date;
        },
        removeAttractionData() {
            this.attraction_date = null;
            localStorage.removeItem("attraction_date");
            return "removed success";
        },
        removeHotelData() {
