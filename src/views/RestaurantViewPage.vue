  ...
  <div class="space-y-2 rounded-lg">
    ...
    <div class="px-4">
      <div class="relative pt-2">
        <div
          class="flex justify-start items-center gap-2 text-main absolute top-3 text-sm"
          @click="goBack"
        >
          <svg
      ...
      <div class="pt-4" v-if="!loading">
        ...
        <div class="space-y-4 px-2 text-base font-semibold mt-3 text-main">
          ...
          <div class="grid grid-cols-2 gap-4">
            <p class="text-xs text-start">City</p>
            ...
            <p class="text-xs text-start">Place</p>
            <p class="text-start font-normal text-xs">
              <!--  -->
              <span class="bg-main/10 py-1 px-2 rounded-md">{{
                hotel?.place
            ...
            <p class="text-xs text-start">Lowest Price</p>
            <p class="text-start font-normal text-xs">
              <!---->
              <span class="bg-main/10 py-1 px-2 rounded-md">
        ...
        <div class="px-2 pt-4 pb-6 space-y-4 text-main font-semibold">
          <p class="text-base">Related Meals</p>
          <div
          ...
          >
            ...
            >
              ...
              <div class="h-[180px] space-y-1 py-4 px-2">
