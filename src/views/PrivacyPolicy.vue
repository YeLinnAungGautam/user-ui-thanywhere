<template>
  <div class="space-y-6">
    <HeaderHome :showTitle="true"></HeaderHome>
    ...
    <div class="space-y-6 px-6">
      ...
      <ul class="pl-10 list-disc space-y-6">
        ...
        <li>
          <p>
            ...
            refers to Thailand Anywhere, the software program provided by the
            Company.
          </p>
        </li>
        <li>
          <p>
            ...
            Agreement) refers to TH Anywhere Co.Ltd,, The Palladium World, 4th
            Floor, Room IT-95, Bangkok, Thailand, Bangkok.
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        The Company allows You to create an account and log in to the Service
      ...
      <p>
        You have the right to delete or request that We assist You with deleting
...
<script setup>
import HeaderHome from "@/components/layout/HeaderHomePage.vue";
</script>
