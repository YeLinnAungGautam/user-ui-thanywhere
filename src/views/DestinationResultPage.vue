    ...
    <div>
      ...
      <div class="space-y-4 relative pb-20">
        ...
        <div v-if="loading" class="space-y-4">
          <div v-for="a in 8" :key="a" class="mx-4 p-2.5">
    ...
    <vue-bottom-sheet ref="myBottomSheet" :max-height="1500">
      <div class="font-poppins relative h-[100vh]">
        ...
        <div class="p-4 ml-4 mr-4 divide-y divide-black/10">
          ...
          <div
            class="flex fixed bottom-0 bg-white left-0 w-full shadow-custom-filter-bottom-sheet justify-between gap-4 items-center py-4 px-4"
          >
            <button
              @click="close"
