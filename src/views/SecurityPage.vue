        ...
        <div class="space-y-5 mt-5">
          ...
          >
            ...
            <div class="h-[60vh] overflow-y-scroll">
              <div class="py-5 border-b border-black/5 px-6">
                <h1 class="text-3xl font-semibold">
                  Privacy Policy for Thailand Anywhere
                </h1>
              </div>
              <div class="space-y-6 px-6">
                ...
                <ul class="pl-10 list-disc space-y-6">
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      <span class="font-semibold">Affiliate</span>
                  ...
                  <li>
                    <p>
                      ...
                      refers to Thailand Anywhere, the software program provided
                      by the Company.
                    </p>
                  </li>
                  <li>
                    <p>
                      ...
                      in this Agreement) refers to TH Anywhere Co.Ltd,, The
                      Palladium World, 4th Floor, Room IT-95, Bangkok, Thailand,
                      Bangkok.
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p>
                      <span class="font-semibold">Usage Data</span>
                ...
                <h3 class="text-2xl font-semibold">Types of Data Collected</h3>
                ...
                <p>
                  The Company allows You to create an account and log in to the
                ...
                <ul class="pl-10 list-disc space-y-6">
                  ...
                  <li>
                    <p>
                      <span class="font-semibold">To manage Your Account:</span>
                  ...
                  <li>
                    <p>
                      <span class="font-semibold">To contact You:</span>
                  ...
                  <li>
                    <p>
                      <span class="font-semibold">To provide You</span>
                  ...
                  <li>
                    <p>
                      <span class="font-semibold">For business transfers:</span>
                  ...
                  <li>
                    <p>
                      <span class="font-semibold">For other purposes:</span>
                ...
                <ul class="pl-10 list-disc space-y-6">
                  <li>
                    <p>
                      <span class="font-semibold">With Service Providers:</span>
                  ...
                  <li>
                    <p>
                      <span class="font-semibold">With Affiliates:</span>
                  ...
                  <li>
                    <p>
                      <span class="font-semibold">With business partners:</span>
                  ...
                  <li>
                    <p>
                      <span class="font-semibold">With other users:</span>
                  ...
                  <li>
                    <p>
                      <span class="font-semibold">With Your consent:</span>
                ...
                <p>
                  You have the right to delete or request that We assist You
                  with deleting the Personal Data that We have collected about
                  You.
                </p>
                <p>
                ...
                <h3 class="text-xl font-semibold">Business Transactions</h3>
                <p>
                ...
                <h3 class="text-xl font-semibold">Other legal requirements</h3>
                <p>
                ...
                <h3 class="text-3xl font-semibold">Children's Privacy</h3>
                <p>
                ...
                <h3 class="text-3xl font-semibold">Links to Other Websites</h3>
                <p>
                ...
                <ul class="pl-10 list-disc space-y-6">
                  <li>By email: negyi.partnerships@thanywhere.com</li>
                </ul>
              </div>
              <div class="border-t border-black/5 py-6 px-6">
            ...
            <div class="space-y-3">
              ...
              <p class="text-xs text-red">
                Please note: Deleting your account will permanently remove all
                associated data, including your orders, cart, and personal
                information. This action cannot be undone.
              </p>
              <div
                class="flex justify-center bg-red rounded-2xl items-center py-2"
                @click="deleteAction"
              >
                <div class="flex justify-start items-center gap-2">
                  <TrashIcon class="w-5 h-5 text-white" />
                  <p class="text-xs text-white">delete account</p>
                </div>
                <ChevronRightIcon class="w-5 h-5" />
              </div>
            </div>
