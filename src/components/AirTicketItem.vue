...
<template>
  <div class="space-y-2 relative overflow-hidden rounded-lg">
    ...
    >
      <img src="../../public/flightticket.jpg" alt="" class="object-cover" />
    </div>
    <div
