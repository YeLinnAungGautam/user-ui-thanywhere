...
onMounted(() => {
  // watchEffect(() => {
  //   if (props.main) {
  //     // If props.main has data, perform actions
  //     console.log("props.main has data:", props.main);

  //     // Assuming getData and changeName are asynchronous functions
  //     getData().then(() => {
  //       changeName();
  //       console.log(formData.value, "this is add");
  //       console.log(formData.value.cost_price);
  //     });
  //   }
  // });
  watch(
    ...
    (newMain, oldMain) => {
      ...
      if (newMain) {
        console.log("props.main has data:", newMain);
