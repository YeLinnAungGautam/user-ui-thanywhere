  ...
  <div>
    ...
    >
      <div
        ...
        :key="i"
      >
        <div class="w-[180px] h-[100px] overflow-hidden">
          <img
        ...
        <div class="px-3 py-2">
          <p class="text-main text-[10px]">amusement part</p>
          <p class="font-semibold text-sm">drean world</p>
          <button
            class="bg-main px-3 mt-2 mb-2 py-1 rounded-lg text-[10px] text-white"
          >
            show detail
          </button>
        </div>
